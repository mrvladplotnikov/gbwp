module.exports = {
  ...
  alertBody: `Наш сайт використовує файли cookie, щоб покращити ваш досвід як користувача. Також ми передаємо інформацію про використання вами сайту нашим консультантам. Дізнайтеся більше в нашій <a href="/privacy-policy">Політиці конфіденційності</a>.
  Натискаючи кнопку "Прийняти", ви погоджуєтесь з тим, щоб файли cookie зберігалися на вашому пристрої.`,
