module.exports = {
  ...
  alertBody: `Наш сайт использует файлы cookie, чтобы улучшить ваш пользовательский опыт. Нажимая кнопку “Принять”, вы соглашаетесь с нашей <a href="/en/privacy-policy">Политикой конфиденциальности</a>.`,
  ...
  <a href="/en/privacy-policy">нашей политикой конфиденциальности</a>.
</p>`,
