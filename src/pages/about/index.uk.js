          ...
          <Inner className={styles.aboutContainer}>
            <div className={styles.aboutCol}>
              ...
              <p>
                ...
                справу.  І зовсім неважливо, про що йде мова: створення музики, звуковий дизайн, голосове
                озвучення, проєктний менеджмент або маркетинг — ми не можемо цим
                не займатися. Тому кожен день ми надихаємо слухачів по обидві
                сторони аудіовізуальних проєктів і отримуємо від цього
                задоволення.
              </p>
            </div>
            <div className={styles.aboutCol}>
