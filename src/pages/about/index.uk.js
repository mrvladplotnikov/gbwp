    ...
    <Layout location={location}>
          ...
          <Inner className={styles.aboutContainer}>
            <div className={styles.aboutCol}>
              ...
              <p>
                ...
                юнацький рок-бунт, який потім переріс у проект{" "}
                <a href="/">Total-Empty</a>. І хоча Влад здобув вищу освіту
                зовсім в іншій сфері, на «серйозну» і стабільну роботу все ж не
                пішов. У вирішальний момент він вибрав музику.
              </p>
              <p>
              ...
              <p>
                Зараз VP Production — це команда людей, де кожен любить свою
                справу. Будь то створення музики, звуковий дизайн, голосове
                озвучення, проектний менеджмент або маркетинг — ми не можемо цим
                не займатися. Тому кожен день ми надихаємо слухачів по обидві
                сторони медіапроектів і отримуємо від цього задоволення.
              </p>
            </div>
            <div className={styles.aboutCol}>
              <img
      ...
      <Why title="І ще" style={{ backgroundColor: "#000" }}>
        ...
        <FeatureCard img={icon5}>
          ...
          задоволені. Переконатися в цьому можна <a href="/">тут</a>.
        </FeatureCard>
      ...
      >
        <h3>
          Завдяки аудіо ми надихаємо слухачів по обидві сторони медіапроектів на
          новий досвід і розкриття власного творчого потенціалу.
        </h3>
      </SectionWithText>
      <Contacts />
    </Layout>
