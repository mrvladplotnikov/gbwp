          ...
          <Inner className={styles.aboutContainer}>
            <div className={styles.aboutCol}>
              ...
              <p>
                ...
                <a href="/">Total-Empty</a>. И хотя Влад получил высшее
                образование совсем в другой сфере, на «серьёзную» и стабильную
                работу всё же не пошёл. В решающий момент он выбрал музыку.
              </p>
              <p>
