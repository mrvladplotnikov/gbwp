  ...
  return (
    ...
    >
      ...
      <ServiceSection title="База голосов">
        <p>
         За годы работы мы сформировали немалую базу актёров голосового озвучивания. Каждый из них — носитель самых разных
      ...
      <ServiceSection title="Как проходит процесс?">
        ...
        <StyledAccordion>
          ...
          <StyledAccordionItem title="Приём проекта">
            ...
            <p> Когда всё готово, мы с вами подписываем Акт приёма-передачи.
            </p>
          </StyledAccordionItem>
