    ...
    >
      <ServiceSection title="Що ми робимо?">
        ...
        <p>
          ...
          до звукового дизайну, так що про неї ви можете прочитати ось тут.
        </p>
        <p>
        ...
        <StyledAccordion>
          <StyledAccordionItem title="Знайомство">
            <p>
              ...
              <a href={mailTo.mail.uk}>безплатну консультацію</a>. Ми
          ...
          <StyledAccordionItem title="Прийом проєкту">
            <p>
              ...
              момент — останній шанс скористатися безплатними правками. </p>
            <p> Коли все
