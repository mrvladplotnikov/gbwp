  ...
  return (
    ...
    >
      ...
      <ServiceSection title="База голосів">
        <p>
          За роки роботи ми сформували чималу базу акторів голосового озвучення. Кожен із них — носій найрізноманітніших
        ...
        <StyledAccordion>
          <StyledAccordionItem title="Знайомство">
            <p>
              ...
              дізнаємося про ваш проєкт. Так ми знайомимося один з одним і
          ...
          <StyledAccordionItem title="Продакшн">
            <p>
              Актор озвучення відправляє нам готовий запис, ми перевіряємо його на відповідність вимогам і, якщо все добре, надсилаємо вам.
      ...
      <ServiceSection title="Вартість">
        <p style={{ marginBottom: 60 }}>
          Вартість проєкту залежить від вибору актора озвучення, базова обробка голосу включена у вартість, специфічна обробка обговорюється окремо.
        </p>
        <PlanList>
          <PlanCard
