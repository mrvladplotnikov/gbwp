    ...
    >
      <ServiceSection title="Что мы делаем?">
        ...
        <p>
          ...
          motion-графики, когда музыка и звуки переплетаются и дополняют друг
        ...
        <StyledAccordion>
          ...
          <StyledAccordionItem title="Подготовка">
            <p>
              ...
              помогаем. Почему мы не делаем ТЗ сами — читайте тут.  </p>
            <p> Кроме того,
      ...
      <ServiceSection title="Стоимость">
        ...
        <p>
          Для озвучивания роликов с motion-графикой стоимость рассчитывается иначе: здесь учитывается сложность картинки и длительность видео.
        </p>
        <p>
      ...
      <ServiceSection title="Наш подход">
        <CardDeck>
          ...
          Для игровых проектов мы имплементируем звуки с помощью Wwise и Fmod — так мы вместе с вами будем уверены в финальном звучании. Мы настраиваем
