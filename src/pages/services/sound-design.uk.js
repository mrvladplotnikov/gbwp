  ...
  return (
    ...
    >
        ...
        <StyledAccordion>
          ...
          <StyledAccordionItem title="Підготовка">
            <p>
              ...
              допомагаємо. Чому ми не робимо ТЗ самостійно — читайте тут.   </p>
            <p> Крім
      ...
      <ServiceSection title="Вартість">
        ...
        <p>
          Для озвучування роликів із motion-графікою вартість розраховується інакше:
      ...
      <ServiceSection title="Наш підхід">
        <CardDeck>
          ...
          <CardDeckItem variant="rect-revers" textAlign="center">
            Для ігрових проєктів ми імплементуємо звуки за допомогою Wwise і Fmod — так ми разом з вами будемо впевнені у фінальному звучанні. Ми
